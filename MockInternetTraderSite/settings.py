"""
Django settings for MockInternetTraderSite project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'webapps-final.herokuapp.com']
...
ROOT_URLCONF = 'MockInternetTraderSite.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            # specifies location to the global templates directory
...
WSGI_APPLICATION = 'MockInternetTraderSite.wsgi.application'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'ROUTING': 'MockInternetTraderSite.routing.channel_routing'
    }
}
...
DATABASES = {
    ...
    # Note: migrate to PostgreSQL in production.
...
# specifies location to global static files directory
STATICFILES_DIRS = [
...
DEFAULT_FILE_STORAGE = 'MockInternetTraderSite.custom_storages.MediaStorage'
...
# to S3 as well
STATICFILES_STORAGE = 'MockInternetTraderSite.custom_storages.StaticFilesStorage'
